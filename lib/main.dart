...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => WeatherCubit(WeatherRepoImpl(WeatherDataSource(Dio()))),
        ),
        BlocProvider(
          create: (context) => CurrentWeatherCubit(WeatherRepoImpl(WeatherDataSource(Dio()))),
        ),
      ],
      child: ScreenUtilInit(
        ...
        builder: (context, child) {
          return MaterialApp.router(
            ...
            theme: ThemeData(primarySwatch: Colors.blue, primaryColor: Colors.transparent),
          );
        },
      ),
    );
